...
const loadable_1 = __importDefault(require("@shuvi/runtime-react/lib/loadable"));
const history_1 = require("@shuvi/runtime-react/lib/router/history");
// @ts-ignore
const router_1 = require("@shuvi/runtime-react/lib/router/router");
