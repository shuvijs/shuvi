...
exports.BUILD_CLIENT_RUNTIME_MAIN_PATH = `${BUILD_CLIENT_DIR}/runtime/main.js`;
exports.BUILD_CLIENT_RUNTIME_WEBPACK_PATH = `${BUILD_CLIENT_DIR}/runtime/webpack.js`;
exports.ENTRY_CLIENT_PATH = resolveSource("client/index");
