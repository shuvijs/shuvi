...
function createWepbackConfig(app, opts) {
    const { paths } = app;
    let chain;
...
exports.createWepbackConfig = createWepbackConfig;
function getClientEntry() {
    return {
        [constants_1.BUILD_CLIENT_RUNTIME_MAIN]: [constants_1.CLIENT_ENTRY_PATH]
    };
}
