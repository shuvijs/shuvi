...
- If something isn’t supported, add a comment and mark it clearly so we can list it later as a to-do
- Keep the original structure unchanged
- Don’t remove any existing comments

# Migrate from webpack

> https://github.com/web-infra-dev/rspack/blob/main/website/docs/en/guide/migration/webpack.mdx
